...
public class TokenService {
    ...
    public String getUsernameFromRefreshToken(String token) throws JwtException {
    ...
    private String createToken(User user, long expiresIn, String key) {
        ...
        claims.put("fullName", String.join(" ", user.getName() + user.getSurname()));
        claims.put("createdTime", user.getCreatedTime().toString());
